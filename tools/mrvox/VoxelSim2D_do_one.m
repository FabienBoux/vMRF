function [Sa, Sphi, G, P] = VoxelSim2D_do_one(ModelFileName,SeqFileName,ModelLineNum,SeqLineNum)
%
%
...
%% INITIALIZATION
% Parameters
P.Vf = Model.geo.vasc.Vf;
P.R  = Model.geo.vasc.R;
P.khi = Model.phy.DH2O;
P.T2 = Model.phy.vasc.T2;
