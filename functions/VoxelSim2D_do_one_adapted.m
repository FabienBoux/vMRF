function [Sa, Sphi, G] = VoxelSim2D_do_one_perso(Model,Seq,ParamNames,ParamValues)
%
%
...
%% Update Model using Parameters
for param = 1:length(ParamNames)
    eval(['Model.' ParamNames{param} ' = ' num2str(ParamValues(param)) ';']);
end
